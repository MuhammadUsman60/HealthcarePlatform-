...
export default function Card4() {
  ...
  const filteredData = data.filter((item) => item.categories === 'Homeopathic & Herbal Products');

  return (
    <div className='row m-4' style={{ width: '98%' }}>
      <h2 className="card-text d-flex justify-content-center mt-4" style={{ color: '#166aa6' }}>Homeopathic & Herbal Products</h2>
